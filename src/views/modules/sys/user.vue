    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-tag v-if="scope.row.delete" size="small" type="danger">禁用</el-tag>
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button v-if="isAuth('sys:user:delete')" type="text" size="small" @click="deleteHandle(scope.row.id)">
            删除
          </el-button>
        </template>
      </el-table-column>
